        ...
        <Table>
          <TableHeader>
            <TableRow className="border-border hover:bg-transparent">
              ...
              <TableHead className="text-muted-foreground hidden xl:table-cell">{t('tableColumns.birthDate')}</TableHead>
              <TableHead className="text-muted-foreground hidden xl:table-cell">{t('tableColumns.procedureDetails')}</TableHead>
            ...
            {loading ? (
              ...
              contacts.map((contact) => (
                ...
                >
                  ...
                  <TableCell className="text-muted-foreground hidden xl:table-cell text-sm whitespace-nowrap">
                    {contact.birth_date ? (
                      new Date(`${contact.birth_date}T00:00:00Z`).toLocaleDateString('pt-BR', {
                        timeZone: 'UTC',
                      })
                    ) : (
                  ...
                  <TableCell className="text-muted-foreground hidden xl:table-cell text-sm max-w-48 truncate">
                    {contact.procedure_details || <span className="text-muted-foreground">-</span>}
                  </TableCell>
